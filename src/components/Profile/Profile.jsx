...
export default function Profile({ name, onLogOut, updateUser, setIsError, isSuccess, setSuccess, isEdit, setIsEdit }) {
  ...
  return (
    <section className="profile page__profile">
      ...
      <Link to={'/'} onClick={onLogOut} className = 'profile__link'>Выйти из аккаунта</Link>
    </section>
  )
}