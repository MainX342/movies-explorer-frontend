...
export default function FilterCheckbox({ isCheck, filterShorts, isLoading }) {
  return (
          ...
          <g id="smalltumb">
            <rect
              className={`search__check-svg-rect${
                isCheck ? " search__check-svg-rect_inactive" : ""
              }`}
              x="1"
              y="3"
              width="34"
            ...
            <circle
              className={`search__check-svg-circle${
                isCheck ? " search__check-svg-circle_inactive" : ""
              }`}
              cx="28"
              cy="10"
              r="5"
